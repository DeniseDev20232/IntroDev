...
class GratefulFamily(Scene):
    ...
    def enter(self):
        ...
        if action == "lick":
            print(dedent("""
                They are excited that Harry is so friendly. They see he doesn't have a collar and take him home at the end of the picnic. They take Harry to the vet, and he is not chipped. The family advertises the found dog, but after 2 weeks, nobody comes forward.
                """))
            return 'foreverhome'
